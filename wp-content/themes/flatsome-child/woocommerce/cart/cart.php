                ...
                <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
                        ...
                        if ($_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters('woocommerce_cart_item_visible', true, $cart_item, $cart_item_key)) {
                            ...
                            <tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                                ...
                                <td class="product-name" data-title="<?php esc_attr_e('Product', 'woocommerce'); ?>">
                                    ...
                                    // Meta data.
                                    echo custom_wc_get_formatted_cart_item_data($cart_item); // PHPCS: XSS ok.
                            ...
                            <tr>
                                <?php wc_get_template('cart/cart-variation-popup.php', array('item_data' => custom_formatted_cart_item_data($cart_item), 'cart_item_key' => $cart_item_key)); ?>
                            </tr>
                            <?php
                        }
                    }
                    ...
                    <tr>
                        <td colspan="6" class="actions clear">
                            ...
                            <button type="submit" class="button primary mt-0 pull-right small" name="update_cart"
