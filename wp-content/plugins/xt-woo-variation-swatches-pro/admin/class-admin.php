...
class XT_Woo_Variation_Swatches_Admin
{
	...
	public function __construct(&$core)
	{
        ...
        $this->core->plugin_loader()->add_action( 'admin_enqueue_scripts', $this, 'enqueue_styles' );
        $this->core->plugin_loader()->add_action( 'admin_enqueue_scripts', $this, 'enqueue_scripts' );

        $this->core->plugin_loader()->add_action( 'admin_init', $this, 'init_attribute_hooks', 1);
        $this->core->plugin_loader()->add_action( 'woocommerce_product_option_terms', $this, 'product_option_terms', 10, 2 );
        $this->core->plugin_loader()->add_action( 'xt_woovs_product_attribute_field', $this, 'attribute_fields', 10, 5);
        $this->core->plugin_loader()->add_filter( 'product_attributes_type_selector', $this, 'add_attribute_types');
	...
	public function get_product_attributes_options() {
	...
	public function enqueue_scripts()
	{
		...
		wp_enqueue_media();
		wp_register_script($this->core->plugin_slug('admin'), $this->core->plugin_url('admin/assets/js', 'admin' . XTFW_SCRIPT_SUFFIX . '.js'), array('jquery', 'wp-color-picker', 'wp-util'), $this->core->plugin_version(), false);
    ...
    public function attribute_swatch_type_field($id, $meta_key, $value = '') {
        ...
        <div>
            <span>
                ...
                <a href="'.esc_url($this->core->access_manager()->get_upgrade_url()).'">'.esc_html__('Upgrade to Unlock!', 'xt-woo-variation-swatches').'</a>
            </span>
        </div><br>';
